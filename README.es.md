...
automatización, base de conocimientos, CMDB, informes y API REST. Qisutu 1.0.1
...
Qisutu 1.0.1 incluye once idiomas completos: alemán (`de`), inglés (`en`),
...
Qisutu 1.0.1 también proporciona la API interna versionada 1.0: servicios
