...
raportami i REST API. Qisutu 1.0.1 jest stabilnym wydaniem do pracy produkcyjnej
...
Qisutu 1.0.1 zawiera jedenaście pełnych języków interfejsu: niemiecki (`de`),
...
Qisutu 1.0.1 udostępnia też wewnętrzne API 1.0: usługi wielokrotnego użytku,
