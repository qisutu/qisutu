...
raportami i REST API. Qisutu 2.0.2 jest stabilnym wydaniem do pracy produkcyjnej
...
Qisutu 2.0.2 zawiera jedenaście pełnych języków interfejsu: niemiecki (`de`),
