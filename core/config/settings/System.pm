...
[
    ...
    },
    {
        ...
        Module       => 'Mail',
        Group        => 'E-Mail-Design',
        Name         => 'Unternehmensname in E-Mails',
        Description  => 'Der Name wird im farbigen Kopf aller Benachrichtigungen und automatischen Antworten angezeigt.',
        Type         => 'text',
        Default      => 'Qisutu',
        SortOrder    => 200,
        Active       => 1,
    },
    {
        ...
        Module       => 'Mail',
        Group        => 'E-Mail-Design',
        Name         => 'Unternehmenslogo in E-Mails',
        Description  => 'PNG-, JPEG- oder GIF-Datei bis 2 MB. Ohne eigenes Logo wird das kleine Qisutu-Logo verwendet.',
        Type         => 'image',
        Default      => '',
        SortOrder    => 210,
        Active       => 1,
