...
[
    ...
    },
    {
        ...
        Module       => 'Mail',
        Group        => 'Translate:SystemSettingMailRetrievalGroup',
        Name         => 'Translate:SystemSettingMailFetchInterval',
        Description  => 'Translate:SystemSettingMailFetchIntervalDescription',
        Type         => 'select',
        Default      => '5',
        PossibleValues => [
            { Value => '1',  Label => '1 min' },
