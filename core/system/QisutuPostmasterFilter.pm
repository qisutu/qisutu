...
sub ConditionDefinitions {
    return [
        { key => 'from_email',          label => 'Translate:PostmasterConditionFromEmail',          type => 'text' },
        { key => 'from_domain',         label => 'Translate:PostmasterConditionFromDomain',         type => 'text' },
        { key => 'from_name',           label => 'Translate:PostmasterConditionFromName',           type => 'text' },
        { key => 'to',                  label => 'Translate:PostmasterConditionTo',                 type => 'text' },
        { key => 'cc',                  label => 'Translate:PostmasterConditionCc',                 type => 'text' },
        { key => 'subject',             label => 'Translate:PostmasterConditionSubject',            type => 'text' },
        { key => 'body',                label => 'Translate:PostmasterConditionBody',               type => 'text' },
        { key => 'subject_body',        label => 'Translate:PostmasterConditionSubjectBody',        type => 'text' },
        { key => 'attachment_name',     label => 'Translate:PostmasterConditionAttachmentName',     type => 'text' },
        { key => 'attachment_extension',label => 'Translate:PostmasterConditionAttachmentExtension',type => 'text' },
        { key => 'attachment_mime',     label => 'Translate:PostmasterConditionAttachmentMime',     type => 'text' },
        { key => 'attachment_count',    label => 'Translate:PostmasterConditionAttachmentCount',    type => 'number' },
        { key => 'has_attachment',      label => 'Translate:PostmasterConditionHasAttachment',      type => 'boolean' },
        { key => 'message_id',          label => 'Translate:PostmasterConditionMessageID',          type => 'text' },
        { key => 'in_reply_to',         label => 'Translate:PostmasterConditionInReplyTo',          type => 'text' },
        { key => 'references',          label => 'Translate:PostmasterConditionReferences',         type => 'text' },
        { key => 'custom_header',       label => 'Translate:PostmasterConditionCustomHeader',       type => 'text', argument => 1 },
        { key => 'mailbox_name',        label => 'Translate:PostmasterConditionMailboxName',        type => 'text' },
        { key => 'mailbox_email',       label => 'Translate:PostmasterConditionMailboxEmail',       type => 'text' },
        { key => 'customer_name',       label => 'Translate:PostmasterConditionCustomerName',       type => 'text' },
        { key => 'customer_company',    label => 'Translate:PostmasterConditionCustomerCompany',    type => 'text' },
        { key => 'existing_ticket',     label => 'Translate:PostmasterConditionExistingTicket',     type => 'boolean' },
    ];
}
...
sub ActionDefinitions {
    return [
        { key => 'queue',                label => 'Translate:PostmasterActionQueue',                target => 'queue' },
        { key => 'state',                label => 'Translate:PostmasterActionState',                target => 'state' },
        { key => 'priority',             label => 'Translate:PostmasterActionPriority',             target => 'priority' },
        { key => 'owner',                label => 'Translate:PostmasterActionOwner',                target => 'agent' },
        { key => 'owner_clear',          label => 'Translate:PostmasterActionOwnerClear',           target => 'none' },
        { key => 'responsible',          label => 'Translate:PostmasterActionResponsible',          target => 'agent' },
        { key => 'responsible_clear',    label => 'Translate:PostmasterActionResponsibleClear',     target => 'none' },
        { key => 'service',              label => 'Translate:PostmasterActionService',              target => 'service' },
        { key => 'sla',                  label => 'Translate:PostmasterActionSLA',                  target => 'sla' },
        { key => 'service_clear',        label => 'Translate:PostmasterActionServiceClear',         target => 'none' },
        { key => 'customer',             label => 'Translate:PostmasterActionCustomer',             target => 'customer' },
        { key => 'customer_user',        label => 'Translate:PostmasterActionCustomerUser',         target => 'customer_user' },
        { key => 'customer_clear',       label => 'Translate:PostmasterActionCustomerClear',        target => 'none' },
        { key => 'title_set',            label => 'Translate:PostmasterActionTitleSet',             target => 'text' },
        { key => 'title_prepend',        label => 'Translate:PostmasterActionTitlePrepend',         target => 'text' },
        { key => 'title_append',         label => 'Translate:PostmasterActionTitleAppend',          target => 'text' },
        { key => 'dynamic_field',        label => 'Translate:PostmasterActionDynamicField',        target => 'dynamic_field_value' },
        { key => 'dynamic_field_clear',  label => 'Translate:PostmasterActionDynamicFieldClear',   target => 'dynamic_field' },
        { key => 'article_visibility',   label => 'Translate:PostmasterActionArticleVisibility',   target => 'visibility' },
        { key => 'sender_type',          label => 'Translate:PostmasterActionSenderType',          target => 'sender_type' },
        { key => 'pending_minutes',      label => 'Translate:PostmasterActionPendingMinutes',      target => 'number' },
        { key => 'ignore',               label => 'Translate:PostmasterActionIgnore',              target => 'none' },
    ];
}
