...
rapporten en REST-API. Qisutu 1.0.1 is een stabiele productieversie en bevindt
...
Qisutu 1.0.1 bevat elf volledige interfacetalen: Duits (`de`), Engels (`en`),
...
Qisutu 1.0.1 levert ook interne API 1.0: herbruikbare services, duurzaam door de
