...
knowledge base, CMDB, reports, and REST API. Qisutu 2.0.2 is a stable release
...
Qisutu 2.0.2 includes eleven complete interface languages: German (`de`),
...
The Qisutu core also provides the versioned internal add-on API 1.0.
