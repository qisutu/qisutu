...
knowledge base, CMDB, reports, and REST API. Qisutu 1.0.1 is a stable release
...
Qisutu 1.0.1 includes eleven complete interface languages: German (`de`),
...
With Qisutu 1.0.1, the core also provides the versioned internal add-on API 1.0.
