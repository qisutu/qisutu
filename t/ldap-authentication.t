...
close $ReleaseFH;
like( $Release, qr{^version=2[.]0[.]2$}m, 'the current release uses program version 2.0.2' );
like( $Release, qr{^database_version=2[.]0[.]2$}m, 'the current release uses database version 2.0.2' );
