...
like( $Release, qr{^version=2[.]0[.]1$}m, 'automatic responses remain included in release 2.0.1' );
like( $Release, qr{^database_version=2[.]0[.]1$}m, 'automatic responses remain included in database version 2.0.1' );
