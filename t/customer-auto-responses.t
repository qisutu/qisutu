...
like( $Release, qr{^version=2[.]0[.]2$}m, 'automatic responses remain included in release 2.0.2' );
like( $Release, qr{^database_version=2[.]0[.]2$}m, 'automatic responses remain included in database version 2.0.2' );
